...
class TfIdf:
    ...
    def get_keywords(self, popular_tfidf, unpopular_tfidf, top_n=5, save=False):
        ...
        for idx in range(len(popular_tfidf)):
            po_keywords_idx = [i for i in np.argsort(popular_tfidf[idx])[-top_n:]]
            unpo_keywords_idx = [i for i in np.argsort(unpopular_tfidf[idx])[-top_n:]]
        ...
        if save==True:
            po_kw_df.to_csv("./LJY/Data/csv/po_kw_df.csv")
            unpo_kw_df.to_csv("./LJY/Data/csv/unpo_kw_df.csv")
...
class Doc2Vec:
    ...
    def get_similarity_rate(self, save=False):
        ...
        if save == True:
            plt.savefig("./LJY/Data/png/lec_similarity_rates.png")
...
class PcaCluster:
    ...
    def _plot_pca_results(df, dim, save=False):
        try:
            ...
            if dim == 2:
                ...
                plt.title("PCA")
                if save == True:
                    plt.savefig("./LJY/Data/png/pca_result_2dim.png")
                plt.show()
            ...
            if dim == 3:
                ...
                ax.set_zlabel('pca3')
                if save == True:
                    plt.savefig("./LJY/Data/png/pca_result_3dim.png")
                plt.show()
    ...
    def Kmeans(self, df, n_cluster=2, show_plot=False, cm= False, save=False):
        ...
        if show_plot == True:
            ...
            plt.show()
            if save == True:
                plt.savefig("./LJY/Data/png/kmeans_plot_3d.png")
        ...
        if cm == True:
            ...
            if save == True:
                plt.savefig("./LJY/Data/png/confusion_mtx.png")
